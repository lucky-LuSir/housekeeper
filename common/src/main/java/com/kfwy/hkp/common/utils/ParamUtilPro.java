...
public class ParamUtilPro<T> {
    ...
    * @return void
    **/
    public void check(T t,List<String> params,Map<String, String> chName) throws IllegalAccessException {
        if(t != null){
            ...
            for(String param : params){
                ...
                if(type == null){
                    ...
                    if(val == null || val == ""){
                        //+"(String)"
                        throw new RemoveStackBusinessException("不能为空,"+chName.get(param)+"("+param+")");
                    }
