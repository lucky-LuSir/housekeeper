 ...
 * @Package com.warmdoctor.ows.core.encode 
 * @author bruce 
 * @date 2015年5月7日 上午9:29:38 
 * @version V1.0 
 */
package com.kfwy.hkp.common.auth;
...
public class Encryption {
	...
	public String getDigestOfString(String data, String accountCode) {
