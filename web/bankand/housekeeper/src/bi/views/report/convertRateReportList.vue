        ...
        <div class="left_bar">
            ...
            <el-main style="padding: 0px">
                ...
                <div class="reght_table">
                    <el-table :data="tableData" id="convertRate" ref="elTable" v-loading="loading" max-height="700">
    ...
    export default {
        ...
        methods:{
            ...
            exportExcel(){
                ...
                //alert("导出开始");
                var reports;
                reports = document.querySelector('#convertRate');
                var wb = XLSX.utils.table_to_book(reports)
                /* 2获得 binary string as output */
                var wbout = XLSX.write(wb, { bookType: 'xlsx', bookSST: true, type: 'array' })
                try {
                    FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '客户转化率.xlsx')
