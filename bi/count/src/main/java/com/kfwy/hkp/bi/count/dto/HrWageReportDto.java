...
public class HrWageReportDto extends BaseEntity {
    ...
    private String cusSerNumber;
    private String cusSerDeptName;
    private String cusSerPeDeptName;
    private BigDecimal cusSerPercentage;
    private BigDecimal cusSerPerformance;
    private String cusSerCode;
    private String cusSerPeDeptCode;
