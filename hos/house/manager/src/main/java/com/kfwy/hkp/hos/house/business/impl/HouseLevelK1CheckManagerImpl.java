...
@Service(value = "k1HouseCheckManager")
public class HouseLevelK1CheckManagerImpl extends AbstractHouseCheckManager {
    ...
    @Override
    public Boolean
    checkFollowUp(HouseEntity house, UserEntity cur, UserEntity owner) {
        if (checkIsMyHos(house)){
            return true;
        }
        return false;
