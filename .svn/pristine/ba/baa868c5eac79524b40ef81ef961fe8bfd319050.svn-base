    ...
    <el-dialog  :close-on-click-modal="false" :visible.sync="dialogFormVisible" style="height: 105%" center
        ...
        <div >
            <el-form :model="customerQuery" ref="customerQuerys"
                     labelWidth="100px">
                <el-row>
                    <span style="font-weight: 900;font-size: 15px;">按条件查询预约</span>
                </el-row>
                <el-row :gutter="5">
                    ...
                    <el-col >
                        <el-form-item label="预约状态" prop="status">
                            <el-radio-group v-model="customerQuery.status" size="mini">
                                ...
                                <el-radio-button label="2">已转化</el-radio-button>
                                <el-radio-button label="5">已作废</el-radio-button>
                            </el-radio-group>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-form-item label="客户全名" prop="cusName">
                        <el-input style="width:220px;"
                                  v-model="customerQuery.cusName"
                                  placeholder="客户完整名字"></el-input>
                    </el-form-item>
                </el-row>
                ...
                <el-row>
                    <el-form-item label="客户电话" prop="cusPhone">
                        <el-input style="width:220px;"
                                  v-model="customerQuery.cusPhone"
                ...
                <el-row>
                    <el-form-item label="房源编码字符" prop="hosCode">
                        <el-input style="width:220px;"
                                  v-model="customerQuery.hosCode"
                                  placeholder="房源编码字符"></el-input>
                    </el-form-item>
                </el-row>
