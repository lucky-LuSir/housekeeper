 ...
 */
public class CustomerCardApiClient {
     ...
     * @return
     */
    public static List<FileRelationEntity> findCustomerCardTransfer(Integer start, Integer pageSize){
        CustomerCardApiRequest request = new CustomerCardApiRequest();
        request.setStart(start);
        request.setPageSize(pageSize);
        request.setKey("@Housekeeper$");
        CustomerCardApiResponse response = HttpRequestUtils.requestPost(request,"http://mo.kufangwuyou.com/kfwy-office/rs/customerTransferApi/customerCardQuery",
