<template slot-scope="scope">
    <div ref="myRoot" style="overflow-y: auto;">
        ...
        <div class="now_page">
            ...
            <div class="content_bar col-sm-12 col-md-12">
                <div id="allmapLocAdd" v-loading="loading" style="overflow:hidden;zoom:1;position:relative;height:65%;">
                    <div id="mapLocRegionAddDiv" style="height:90%;-webkit-transition: all 0.5s ease-in-out;transition: all 0.5s ease-in-out;"></div>
                </div>
...
<script scoped>
    ...
    export default {
        ...
        mounted(){
            ...
            var map = new BMap.Map('mapLocRegionAddDiv', { enableMapClick: false });
            //十字架型
            map.setDefaultCursor("default");
            this.bdmap= map;

            let hkpRegionCityObj = JSON.parse(localStorage.getItem("hkpRegionCityAddList"));
        ...
        methods: {
            ...
            handleSure(){
                ...
                else if(isPolygon==true){this.basicNetAddLocRegion();}
                let obj = {};
                obj.msg = "子组件--地图--确定按钮";
                //this.remove_overlay();
...
//                        titleMsg = "<button type=\"button\" class=\"btn btn-success btn-xs\" onclick='addRegionFunc()'>添加区域</button>";
                        ...
                        //alert("看看");
                        console.log("下面是hosTbList"+vm.hosTbList[0].houseLocation.locationAlias);
                        console.log(vm.hosTbList);
                        if(obj !=null){
                            titleMsg = titleMsg + vm.hosTbList[0].houseLocation.locationAlias+"&nbsp&nbsp&nbsp---";
                        }
                    ...
                    vm.needRemoveMarker = markerNowPoi;
                        titleMsg = titleMsg +"已关联房源"+response.data.stackTrace+"个.";
...
//                        infoMsg = infoMsg+"<div id=\"myCarousel\" class=\"carousel slide\">"+
...
//                            "</div> "
                        ...
                        infoMsg = infoMsg+"<span>";
                        infoMsg = infoMsg+"别名:&nbsp&nbsp&nbsp"+vm.houseLocationObj.locationAlias;
                        infoMsg = infoMsg+"</span></br>";
