            ...
            <el-aside width="35%" class="el-aside">
                <el-card class="box-border" :style="{height: fullHeight/2 -100 + 'px'}" shadow="hover">
                    ...
                    <el-row style="margin-top: 10px">
                        <el-tag type="primary" size="small">
                            于{{cooperateEntity.createTime | time}}向TA申请
                        </el-tag>
                    </el-row>
                </el-card>
                <el-card class="box-border" :style="{height: fullHeight/2 -80 + 'px'}" shadow="hover">
                        ...
                        <div>
                            <div style="font-weight: bold;font-size: 14px;"
                                ...
                                <p><span class="el-icon-chat-dot-round"
                                    ...
                                    您申请与TA{{cooperateEntity.streetName}} {{cooperateEntity.area}}㎡的房源进行合作
                                </p>
                                <p>
                    ...
                    <el-row>
                        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" :offset="0">
                            <el-row v-if="cooperateEntity.cooStatus=='1'" style="margin-top: 40px">
                                <el-row>
                                    <el-button icon="el-icon-check" type="primary" size="medium"
                                               circle/>
                                </el-row>
                                <el-row style="margin-top: 5px">
                                    <span style="color: #409EFF;font-weight: bold">待审核</span>
                                </el-row>
                            </el-row>
                        ...
                        <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12" :offset="0">
                            <el-row v-if="cooperateEntity.cooStatus=='3'" style="margin-top: 40px">
                                <el-row>
                                    <el-button @click="endCooperate()" icon="el-icon-turn-off-microphone" type="danger"
                                               size="medium" circle/>
                                </el-row>
                                <el-row style="margin-top: 5px">
            ...
            <el-aside width="65%">
                <div>
                    ...
                    <el-tabs v-if="cooperateEntity.cooStatus!='2'" type="border-card"
                            v-model="dislogType"
                            @tab-click="typeCheck()">
                        <el-tab-pane v-if="cooperateEntity.applyType == '1'" label="我有以下几位准客户" name="1">
                            <hos-match-cus ref="hosMatchCuss"/>
                        </el-tab-pane>
                        <el-tab-pane v-if="cooperateEntity.applyType == '2'" label="我有以下房可以推荐" name="1">
                        ...
                        <el-tab-pane label="合作动态" name="2">
                            <hos-followup-list :houseCodeFollowup="houseCodeFollowup"
                                               v-if="cooperateEntity.applyType == '1'"
                                               ref="hosFollowup"/>
                            <cus-followup-list v-if="cooperateEntity.applyType == '2'" ref="cusFollowup"/>
                        </el-tab-pane>
                    </el-tabs>
                    <!--已拒绝-->
