...
public class FocusPayBackWageReportEntity extends BaseEntity {
    ...
    //返佣扣款
    private BigDecimal commissionDeductions;
    //税金扣款
    ...
    /**
     * 剔除后实际业绩(回款金额-返佣-应扣税金)  只减一次
     */
    private BigDecimal comeCommission;

    private BigDecimal focusProfit;
     ...
     * 分成所属父级分店
     */
    private String peParentDeptCode;

    private String peParentDeptName;
    /**
     * 分成所属分店
     */
    ...
    public BigDecimal getFocusProfit() {
        return focusProfit;
    }

    public void setFocusProfit(BigDecimal focusProfit) {
        this.focusProfit = focusProfit;
    }
    ...
    public BigDecimal getCommissionDeductions() {
        return commissionDeductions;
    }

    public void setCommissionDeductions(BigDecimal commissionDeductions) {
        this.commissionDeductions = commissionDeductions;
    }
    ...
    public String getPeParentDeptCode() {
        return peParentDeptCode;
    }

    public void setPeParentDeptCode(String peParentDeptCode) {
        this.peParentDeptCode = peParentDeptCode;
    }

    public String getPeParentDeptName() {
        return peParentDeptName;
    }

    public void setPeParentDeptName(String peParentDeptName) {
        this.peParentDeptName = peParentDeptName;
    }
