<template>
    <div>
        ...
        <el-button type="warning" plain @click="fileOpen">上传文件</el-button>


        <el-dialog  :close-on-click-modal="false" append-to-body  height="100%" :visible.sync="isShowFile" width="90%"  top="3vh"  >
                ...
                <div class="size-right">
                    ...
                    <div v-if="fileType == 'video'" >
                        <video  width="100%" height="50%" style="max-height: 500px" controls autobuffer>
