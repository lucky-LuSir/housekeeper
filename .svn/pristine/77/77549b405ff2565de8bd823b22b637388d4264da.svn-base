<template>
    ...
    <div>
        ...
        <cooperate-detail ref="cooDetail" v-if="visible"/>
                        ...
                        <div style="padding: 6px">
                            ...
                            <div style="margin-top: 20px;height: 300px;width:210px;float: left;text-align:left;padding-left: 15px;">
                                ...
                                <div style="height: 70px">
                                    <div style="width: 200px;font-weight: bold;font-size: 12px;margin-top: 10px"
                                        ...
                                        <p><span class="el-icon-chat-dot-round"
                                            ...
                                            您申请与TA{{item.streetName}} {{item.area}}㎡的房源进行合作
                                        </p>
                                ...
                                <div style="text-align: right;padding-right: 20px">
                                    <el-button @click="openCooDetail(item.cooCode)" type="primary" size="mini" icon="el-icon-view">查看
                                    </el-button>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    import cooperateDetail from "./cooperateDetail.vue";
    ...
    export default {
        ...
        methods: {
            ...
            myApply(obj) {
                ...
                sendObj.entity = obj;
                sendObj.entity.applyCode = this.$cookieStore.getCookie("userCode");
                var option = {
                    method: 'POST',
            ...
            openCooDetail(cooCode){
                ...
                vm.visible=true;
                vm.$nextTick(()=>{
                    this.$refs.cooDetail.visible = true;
                    this.$refs.cooDetail.cooCode=cooCode;
                    this.$refs.cooDetail.getCooperateDetails();
                })
            }
        }
    }
