 ...
 */
@Component
public class HrWageReportSecondJob {

    private static final Logger LOGGER = LoggerFactory.getLogger(HrWageReportSecondJob.class);
    ...
    public void start() {
        LOGGER.info("--------------[人事版工资报表税金返佣扣款第二次]-任务开始--------------");
        ...
        LOGGER.info("--------------[人事版工资报表税金返佣扣款第二次]-任务结束--------------");
    }
